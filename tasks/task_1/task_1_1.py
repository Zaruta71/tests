def generate_course_list(courses, mentors, durations):
...
courses_list = generate_course_list(courses, mentors, durations)
#print(courses_list)
# [{'title': 'Java', 'mentors': ['User1', 'User2'], 'duration': 14}]
...
maxes = []
minis = []
for key, value in enumerate(durations):
    if value == max:
        maxes.append(key)
    elif value == min:
        minis.append(key)
