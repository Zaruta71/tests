def create_duration_couples(courses_list):
    duration_index = []
    mcount_index = []
    ...
    return duration_index, mcount_index
...
duration_index, mcount_index = create_duration_couples(courses_list=courses_list)

# print(duration_index, mcount_index)
...
duration_index = sorted(duration_index)
mcount_index = sorted(mcount_index)
